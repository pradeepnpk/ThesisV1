...
\title{Quantum electrodynamics in structured environments using superconducting circuits}

%***YOUR NAME***
%Do not include initials or middle names. Do not include your supervisor(s)' name(s).
\author{Pradeepkumar Nandakumar}
...
\orcid{\href{https://orcid.org/0000-0002-6383-995X}{ORCID}}
